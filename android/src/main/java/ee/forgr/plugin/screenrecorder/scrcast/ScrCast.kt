package ee.forgr.plugin.screenrecorder.scrcast;
...
import ee.forgr.plugin.screenrecorder.scrcast.internal.config.dsl.OptionsBuilder
import ee.forgr.plugin.screenrecorder.scrcast.extensions.supportsPauseResume
import ee.forgr.plugin.screenrecorder.scrcast.internal.recorder.*
import ee.forgr.plugin.screenrecorder.scrcast.recorder.*
import ee.forgr.plugin.screenrecorder.scrcast.recorder.RecordingState.*
import ee.forgr.plugin.screenrecorder.scrcast.recorder.RecordingStateChangeCallback
import ee.forgr.plugin.screenrecorder.scrcast.recorder.notification.NotificationProvider
import ee.forgr.plugin.screenrecorder.scrcast.internal.recorder.notification.RecorderNotificationProvider
import ee.forgr.plugin.screenrecorder.scrcast.internal.recorder.service.RecorderService
import ee.forgr.plugin.screenrecorder.scrcast.internal.request.RecordScreen
import java.io.File
        ...
        when (state) {
            is Idle -> {
                Dexter.withContext(activity)
                    .withPermissions(Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.READ_EXTERNAL_STORAGE,Manifest.permission.RECORD_AUDIO)
